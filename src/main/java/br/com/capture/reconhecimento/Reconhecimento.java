...
public class Reconhecimento {
    public static void main(String args[]) throws FrameGrabber.Exception {
        ...
        //IMPORTANDO O ARQUIVO DO HAARCASCADE
        ...
        //0 SIGNIFICA A MINHA WEBCAN
        OpenCVFrameGrabber camera = new OpenCVFrameGrabber(0);
        camera.start();

        //FAZENDO A TELA PARA RENDERIZAR A IMAGEM DA WEBCAN
        ...
        //LAÇO QUE A CAMERA FICA DETECTANDO ROSTO
        while ((frameCapture = camera.grab()) != null) {
            ...
            for (int i = 0; i < facesDetecteds.size(); i++) {
                ...
                //FAZ O RETANGULO AO REDOR DA CARA
                ...
                if (predict == -1) {
                    ...
                    if (predict == 1) {
                        nome = pessoas.get(predict) + " - " + format.format(confianca.get(0)) + " - ADMIN";
                    } else {
                        nome = pessoas.get(predict) + " - " + format.format(confianca.get(0)) + " - USER";
                    }
                }
                ...
                //COLOCANDO O TEXTO AO REDOR DO RETANGULO
                putText(
                        imageColor,
                        nome,
